...
<#function insertVal column>
    <#if column.sqlName == "GMT_CREATE" || column.sqlName == "GMT_MODIFIED"><#return "now()"></#if>
...
<#function updateVal column>
    <#if column.sqlName == "LAST_UPDATED" || column.sqlName == "GMT_MODIFIED"><#return "now()"></#if>
    <#return '${"#"}{${column.javaName},jdbcType=${column.sqlType}}'/>
</#function>

<#-- update 中需要设置的字段 -->
<#function updateIncludeColumn column primaryKeys>
    <#if column.sqlName == "CREATOR" || column.sqlName == "DATE_CREATED" || column.sqlName == "GMT_CREATE">
        <#return false>
    </#if>
